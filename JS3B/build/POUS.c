...
void JS3B_init__(JS3B *data__, BOOL retain) {
  __INIT_VAR(data__->START,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->LOCK,__BOOL_LITERAL(FALSE),retain)
...
// Code part
void JS3B_body__(JS3B *data__) {
  // Initialise TEMP variables

  __SET_VAR(data__->,CON1,,((!(__GET_VAR(data__->SENSOR1,)) && __GET_VAR(data__->STOP,)) && ((!(__GET_VAR(data__->LOCK,)) && __GET_VAR(data__->START,)) || __GET_VAR(data__->CON1,))));
  __SET_VAR(data__->,CON2,,((!(__GET_VAR(data__->SENSOR2,)) && __GET_VAR(data__->STOP,)) && (__GET_VAR(data__->CON2,) || __GET_VAR(data__->SENSOR1,))));
  __SET_VAR(data__->,LOCK,,(__GET_VAR(data__->STOP,) && (__GET_VAR(data__->CON1,) || __GET_VAR(data__->LOCK,))));
