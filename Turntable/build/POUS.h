...
typedef struct {
  ...
  __DECLARE_VAR(BOOL,SEN3)
  __DECLARE_VAR(BOOL,TFRONTLIMIT)
  __DECLARE_VAR(BOOL,TFRONTLIMIT90)
  __DECLARE_VAR(BOOL,CON1)
  __DECLARE_VAR(BOOL,CON2)
  __DECLARE_VAR(BOOL,TURNROLL)
  __DECLARE_VAR(BOOL,TURNTABLE)
  __DECLARE_VAR(BOOL,SEN1VIR)
