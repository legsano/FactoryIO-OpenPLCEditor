...
void MUTERR_init__(MUTERR *data__, BOOL retain) {
  ...
  __INIT_VAR(data__->SEN3,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->TFRONTLIMIT,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->TFRONTLIMIT90,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->CON1,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->CON2,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->TURNROLL,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->TURNTABLE,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->SEN1VIR,__BOOL_LITERAL(FALSE),retain)
}

// Code part
void MUTERR_body__(MUTERR *data__) {
  // Initialise TEMP variables
  ...
  if (!(__GET_VAR(data__->STOP,))) {
    __SET_VAR(data__->,TURNTABLE,,__BOOL_LITERAL(FALSE));
  };
  if (!(__GET_VAR(data__->STOP,))) {
    __SET_VAR(data__->,TURNROLL,,__BOOL_LITERAL(FALSE));
  };
  if (__GET_VAR(data__->SEN1,)) {
    __SET_VAR(data__->,TURNROLL,,__BOOL_LITERAL(TRUE));
  };
  __SET_VAR(data__->,TURNTABLE,,__GET_VAR(data__->TFRONTLIMIT,));
  if (__GET_VAR(data__->TFRONTLIMIT,)) {
    __SET_VAR(data__->,TURNROLL,,__BOOL_LITERAL(FALSE));
  };
  if (__GET_VAR(data__->TFRONTLIMIT90,)) {
    __SET_VAR(data__->,TURNROLL,,__BOOL_LITERAL(TRUE));
  };
  if (__GET_VAR(data__->SEN2,)) {
    __SET_VAR(data__->,TURNROLL,,__BOOL_LITERAL(FALSE));
  };
